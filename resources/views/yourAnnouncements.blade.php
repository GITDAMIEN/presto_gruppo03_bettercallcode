          ...
          <div class="col-12 col-md-6 col-lg-3 pt-4">
            <div class="Mycard mx-auto" style="width: 95%;">
              ...
              <div class="card-body">
                ...
                {{-- <form method="POST" action="{{route('deleteAnnounce', compact('announcement'))}}" class="buttonbox mt-3 ms-1">
                  @csrf
                  @method('delete')
                  <button type="submit" class="btn custombtnBg2 panna mb-3 mt-1 ms-pers">{{__('ui.deteleYourAnn')}}</button>
                </form> --}}
              </div>
      ...
      <div class="container mt-5 py-5">
        <div class="row">
          <div class="col-12 d-flex justify-content-center align-items-center">
            <div class="aa ps-5">
              <a href="{{route('createAnnouncement')}}" class="btnPd">{{__('ui.add-your-first-ann')}}</a>
            </div>
          </div>
        </div>
      </div>
