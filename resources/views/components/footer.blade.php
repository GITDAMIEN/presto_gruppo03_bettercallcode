<footer id="footerContainer" class="container-fluid mt-5">
        <div class="container">
            <div class="row py-4">
                <div id="footerPart1" class="col-6 col-md-4">
                    ...
                    <div id="mottoPDiv" class="row">
                        <p class="ubuntuFont cblack fw-bold">{{__('ui.home-title')}}</p>
                    </div>
                    <div class="row mt-2">
                        <div class="col-1">
                            <i class="contactsIcons starry fa-solid fa-location-dot"></i>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-1">
                            <i class="contactsIcons starry fa-solid fa-envelope"></i>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-1">
                            <i class="contactsIcons starry fa-solid fa-phone"></i>
                        </div>
                ...
                <div class="col-6 col-md-3 mt-3">
                    <ul id="footerCategoriesList" class="starry ubuntuFont">
                ...
                <div class="col-6 col-md-3">
                    <ul id="footerInfoList" class="starry ubuntuFont mt-3">
                        ...
                        <li id="footerInfoListItem" class="d-flex align-items-center py-1">
                            ...
                            <i id="footerInfoListIcon" class="fa-solid fa-circle-arrow-right ms-2 d-none"starry"></i>
                        </li>
                        <li id="footerInfoListItem" class="d-flex align-items-center py-1">
                ...
                <div class="col-6 col-md-2 pe-md-0">
                    <div id="footerAppsSection" class="row mx-0 px-md-0">
                        <ul id="footerAppsLinks" class="starry ubuntuFont px-md-0 mt-3 ps-0">
                    ...
                    <div id="footerSocialsSection" class="row px-md-0 mt-3 mx-0">
                        <h6 id="footerSocialsTitle" class="fw-bold fs-5 pb-2 mb-0 px-0 ubuntuFont starry">SOCIAL</h6>
